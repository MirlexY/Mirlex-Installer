...
def coklu2 ():
    select = input("Lütfen indirmek istediğiniz uygulamaları seçin: ")
    ...
    while True:
        for i in range (num_selected):
            ...
            if num in indirilecekler:
                ...
                print("!!! Geçersiz seçeneği seçtiniz lütfen tekrardan giriniz !!!")
                coklu2()
        select2=input("Devam Etmek İstiyor musunuz?|Y/N: ").upper()
        if select2=="Y":
            coklu()
        else:
            cıkıs()
...
Eğer çoklu indirmek isterseniz ÖRNEK = 0,1,2,3
Eğer tekli indirmek isteseniz ÖRNEK = 0

↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑

Lütfen indirmek istediğiniz uygulamaları seçin: """)
    selection = select.split(',')
    num_selected = len(selection)
    while True:
        for i in range (num_selected):
